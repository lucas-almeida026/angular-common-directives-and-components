(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@juggle/resize-observer')) :
    typeof define === 'function' && define.amd ? define('ng-resize-observer', ['exports', '@angular/core', 'rxjs', '@juggle/resize-observer'], factory) :
    (global = global || self, factory(global['ng-resize-observer'] = {}, global.ng.core, global.rxjs, global.resizeObserver));
}(this, (function (exports, core, rxjs, resizeObserver) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var RESIZE_OBSERVER = new core.InjectionToken("Resize Observer", {
        providedIn: "root",
    ...
    var ResizeObserverService = /** @class */ (function () {
        function ResizeObserverService(chgRef, el, ResizeObserver) {
            ...
            this.onResizeSubject = new rxjs.Subject();
        ...
        ResizeObserverService.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [RESIZE_OBSERVER,] }] }
        ]; };
        ResizeObserverService = __decorate([
            core.Injectable(),
            __param(1, core.Optional()),
            __param(2, core.Inject(RESIZE_OBSERVER))
    ...
    function ponyFillFactory() {
        return window.ResizeObserver || resizeObserver.ResizeObserver;
    }
    ;
    ...
    exports.NgResizeObserver = NgResizeObserver;
    exports.NgResizeObserverPonyfillModule = NgResizeObserverPonyfillModule;
    exports.ngResizeObserverProviders = ngResizeObserverProviders;
    exports.ngResizeObserverProvidersWithPonyfill = ngResizeObserverProvidersWithPonyfill;
    exports.ɵa = ResizeObserverService;
    exports.ɵb = ngResizeObserverFactory;
    exports.ɵc = NgResizeObserverProvider;
    exports.ɵd = ponyFillFactory;
    exports.ɵe = polyfillProvider;
    exports.ɵg = RESIZE_OBSERVER;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng-resize-observer.umd.js.map
